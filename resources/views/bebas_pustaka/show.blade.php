@section('title', 'Detail Pengajuan Bebas Pustaka')
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="fw-semibold">{{ $req->rejection_note ?? $req->fine_note ?? '-' }}</div>
                        </div>
                        <div class="col-md-6">
                            <div class="text-muted small">Surat</div>
                            <div class="fw-semibold">
                                @if($req->letter_id)
                                    <a href="{{ route('bebas_pustaka.download', $req->id) }}" class="btn btn-sm btn-outline-primary">
                                        Unduh Surat
                                    </a>
                                @else
